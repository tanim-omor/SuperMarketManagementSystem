...
console.log(cookies.ssms)

var hidden = document.getElementById('hidden');

hidden.value = cookies.ssms

console.log("cookie splited to", hidden.value)
